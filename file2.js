let Elevator={
               ...
               for(optionB;requested<=optionB;optionB--){
                console.log(optionB);
                  ...
                  for(optionB;requested<=optionB;optionB--){
                     ...
                     for(optionB;requested<=optionA;optionA--){
                        ...
                        for(optionA;requested<=optionA;optionA--){
                          ...
                          for(optionB;requested<=optionB;optionB--){
                           ...
                           else if(requestedDirection == 'up' | requestedDirection == 'down' &&  moveA=='moving' && optionA > 5 && requested > 5  &&  optionA > requested ){
                            console.log('ELEVATOR A IS COMMING');
                   ...
                   return optionA,optionB,requested,requestedDirection,moveA,moveB; //return value
   ...
   for(choice;floor<=choice;floor++){
     ...
     findBestElevator(2,6,1,'up','idle','idle');//(optionA,optionB,requested,requestedDirection)
     ...
     findBestElevator(10,3,1,'up','idle','idle');//(optionA,optionB,requested,requestedDirection,moveA,moveB) 
    ...
    findBestElevator(10,6,3,'up','idle','idle');//(optionA,optionB,requested,requestedDirection,moveA,moveB) 
    InsideElevator(3,5);//(floor,choice)
    console.log('door open\n');
    console.log('third person');
    
    findBestElevator(10,5,9,'down','idle','idle');//(optionA,optionB,requested,requestedDirection,moveA,moveB) 
